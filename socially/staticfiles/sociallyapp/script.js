$(document).ready(function() {
  ...
  const $postContent = $('#post-content');
        ...
        $gptSuggestionButton.click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $gptSuggestionBox.html(`<div class="alert alert-info">${response.response}</div>`);
                },
                error: function(xhr) {
                    $gptSuggestionBox.html('<div class="alert alert-danger">Failed to get GPT suggestion. Please try again.</div>');
                }
            });
        });
